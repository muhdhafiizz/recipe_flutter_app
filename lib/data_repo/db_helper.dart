...
class DbHelper {
      ...
      onCreate: (db, version) {
        ...
        db.insert(
          tableName,
          {
            ...
            isFavoriteColumn: 0,
            columnIngredients:
                'Chicken, Fettuccine, Cream, Garlic, Parmesan, Butter',
            columnInstructions:
                'Cook pasta. Sauté chicken. Make Alfredo sauce. Combine.',
            columnImage: '',
        ...
        db.insert(
          tableName,
          {
            ...
            columnInstructions:
                'Cook pasta. Fry pancetta. Mix eggs and cheese. Combine everything.',
            columnImage: '',
        ...
        db.insert(
          tableName,
          {
            ...
            columnInstructions:
                'Mix ingredients. Heat a skillet. Pour batter and cook until bubbles form, then flip.',
        ...
        db.insert(
          tableName,
          {
            ...
            isFavoriteColumn: 0,
            columnIngredients:
                'Salmon fillets, Olive oil, Lemon, Garlic, Herbs, Salt, Pepper',
            columnInstructions:
                'Preheat grill. Brush salmon with oil and season. Grill for 6-8 minutes on each side.',
            columnImage: '',
  ...
  deleteOneRecipe(RecipeModel recipeModel) {
    database
        .delete(tableName, where: '$columnId=?', whereArgs: [recipeModel.id]);
  }
  ...
  updateFavourite(RecipeModel recipeModel) async {
    await database.update(
      tableName,
      {isFavoriteColumn: recipeModel.isFavorite ? 1 : 0},
      where: '$columnId = ?', 
